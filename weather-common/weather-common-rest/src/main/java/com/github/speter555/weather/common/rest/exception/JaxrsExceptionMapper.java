...
import com.github.speter555.weather.api.jakarta.dto.exception.enums.FaultType;
...
public class JaxrsExceptionMapper implements ExceptionMapper<WebApplicationException> {
    ...
    /**
     * "It searches for the {@code ResourceInvoker} with a wildcard content type. This is used to determine if there are any errors with the request
     * besides an invalid content type
     *
